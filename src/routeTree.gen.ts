...
const AuthenticatedVersementsAVerserLazyImport = createFileRoute(
...
const AuthenticatedVersementsIndexLazyRoute =
  AuthenticatedVersementsIndexLazyImport.update({
    ...
    import('./routes/_authenticated/versements/index.lazy').then(
      (d) => d.Route,
    ),
  )
...
const AuthenticatedVersementsEnRetardLazyRoute =
  AuthenticatedVersementsEnRetardLazyImport.update({
    id: '/versements/en-retard',
    path: '/versements/en-retard',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any).lazy(() =>
    import('./routes/_authenticated/versements/en-retard.lazy').then(
      (d) => d.Route,
    ),
  )

const AuthenticatedVersementsAVerserLazyRoute =
  AuthenticatedVersementsAVerserLazyImport.update({
    id: '/versements/a-verser',
    path: '/versements/a-verser',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any).lazy(() =>
    import('./routes/_authenticated/versements/a-verser.lazy').then(
      (d) => d.Route,
    ),
  )
...
const AuthenticatedRapportsRepartitionDepartementsLazyRoute =
  AuthenticatedRapportsRepartitionDepartementsLazyImport.update({
    id: '/rapports/repartition-departements',
    path: '/rapports/repartition-departements',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any).lazy(() =>
    import(
      './routes/_authenticated/rapports/repartition-departements.lazy'
    ).then((d) => d.Route),
  )
...
const AuthenticatedDemandesIdPdfLazyRoute =
  AuthenticatedDemandesIdPdfLazyImport.update({
    id: '/demandes/$id/pdf',
    path: '/demandes/$id/pdf',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any).lazy(() =>
    import('./routes/_authenticated/demandes/$id/pdf.lazy').then(
      (d) => d.Route,
    ),
  )
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/rapports/repartition-departements': {
      ...
      path: '/rapports/repartition-departements'
      fullPath: '/rapports/repartition-departements'
      preLoaderRoute: typeof AuthenticatedRapportsRepartitionDepartementsLazyImport
      parentRoute: typeof AuthenticatedRouteImport
    }
    '/_authenticated/rapports/tableau-mensuel': {
    ...
    '/_authenticated/versements/a-verser': {
      id: '/_authenticated/versements/a-verser'
      path: '/versements/a-verser'
      fullPath: '/versements/a-verser'
      preLoaderRoute: typeof AuthenticatedVersementsAVerserLazyImport
      parentRoute: typeof AuthenticatedRouteImport
    }
    '/_authenticated/versements/en-retard': {
      id: '/_authenticated/versements/en-retard'
      path: '/versements/en-retard'
      fullPath: '/versements/en-retard'
    ...
    '/_authenticated/demandes/$id/pdf': {
      id: '/_authenticated/demandes/$id/pdf'
      path: '/demandes/$id/pdf'
      fullPath: '/demandes/$id/pdf'
      preLoaderRoute: typeof AuthenticatedDemandesIdPdfLazyImport
      parentRoute: typeof AuthenticatedRouteImport
    }
...
/* ROUTE_MANIFEST_START
{
  "routes": {
    ...
    "/_authenticated/rapports/repartition-departements": {
      "filePath": "_authenticated/rapports/repartition-departements.lazy.tsx",
      "parent": "/_authenticated"
    },
    "/_authenticated/rapports/tableau-mensuel": {
    ...
    "/_authenticated/versements/a-verser": {
      "filePath": "_authenticated/versements/a-verser.lazy.tsx",
      "parent": "/_authenticated"
    },
    "/_authenticated/versements/en-retard": {
    ...
    "/_authenticated/demandes/$id/pdf": {
      "filePath": "_authenticated/demandes/$id/pdf.lazy.tsx",
      "parent": "/_authenticated"
    },
    "/_authenticated/demandes/$id/": {
