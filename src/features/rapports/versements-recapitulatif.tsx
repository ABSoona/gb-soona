...
import { RapportVersementRow, useRapportVersementsRecapitulatifService } from '@/api/rapport/rapportVersementsService'
...
const exportToCsv = (rows: RapportVersementRow[]) => {
  ...
  link.href = url
  link.setAttribute('download', 'rapport_recapitulatif_versements.csv')
...
export default function VersementsRecapitulatif() {
  ...
  const { rows, montantTotalPeriode, loading } = useRapportVersementsRecapitulatifService(dateRange.from, dateRange.to)
    ...
    <>
      ...
      <Main>
        <div className='mb-2 flex items-center justify-between space-y-2'>
          <h1 className='text-xl font-bold tracking-tight'>Récapitulatif des versements</h1>
        ...
        <p className='mb-4 text-xs text-muted-foreground'>
          Versements au statut « Versé » uniquement, regroupés par mois selon leur date de versement, sur la période sélectionnée.
        </p>
