...
export function VisitesTable({ columns, data, hideTools = false, hideActions = false, showDetailIn = detailOpenOption.sheet }: DataTableProps) {
                                            ...
                                            /* onClick={(e) => {
                                                if (cell.column.id !== 'actions') {
                                                    if (showDetailIn == detailOpenOption.page) {
                                                        navigate({
                                                            to: `/visites/${row.original.id.toString()}`,
